...
import { as as beatenPathTo, Core } from '../nominals'
import { BeatenPathStyle } from './types'

const BEATEN_PATH_INITIAL_CORE: Core = beatenPathTo.Core(5)
const BEATEN_PATH_INITIAL_REPETITIONS: Cardinal = as.Cardinal(1)
...
const PRESET_DENSE_REPETITIONS: Cardinal = as.Cardinal(4)
