...
import { as, Cycle, insteadOf, map, Ms, Ordinal, Translation, use } from '@musical-patterns/utilities'
    ...
    (specs: BeatenPathSpecs): Entity[] => {
        ...
        return map(
            ...
            (entityNotes: Note[], index: Ordinal<Note[][]>): Entity => ({
                delay: use.Ordinal(delays, insteadOf<Ordinal, Array<Translation<Ms>>>(index)),
