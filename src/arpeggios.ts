...
const buildArpeggioNoteBlocks: (beatenPathRatios: number[][], beatenPathNoteBlocks: Notes[][]) => Notes[] =
    (beatenPathRatios: number[][], beatenPathNoteBlocks: Notes[][]): Notes[] =>
        beatenPathRatios.map((ratioTuple: number[], index: number): Notes => {
